...
const Header = ({ userEmail, onSignOut, wallets = [], selectedWalletId = null, onWalletChange, pageTitle }: HeaderProps) => {
  ...
  return (
    <nav className="w-full bg-[#18181b] border-b border-gray-800 flex items-center justify-between shadow-sm z-20">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-10 flex items-center justify-between">
